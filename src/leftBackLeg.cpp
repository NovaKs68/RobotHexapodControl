...
LeftBackLeg::LeftBackLeg() : Leg(10, 11, 12)
{
    ...
    m_servoTibia.WRITE_Servo_Offset_Adjust(-3);
}

int LeftBackLeg::posReadyToWalk(double timeCoxa, double timeFemur, double timeTibia)
{
...
int LeftBackLeg::posDownToPosReadyToWalk1()
{
    Board &board = Board::Instance();
    for (int i = 1; i <= 2000; i++)
    {
