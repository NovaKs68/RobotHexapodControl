        ...
        if (m_boardActive)
        {
            ...
            if (nbrServoAActualiser != 0)
            {
                ...
                for (int i = 0; i < nbrServoAActualiser; i++)
                {
                    ...
                    if (currentAngle >= (m_boardServosAngle[servoIdAActualiser[i] - 1] - 5) && currentAngle <= (m_boardServosAngle[servoIdAActualiser[i] - 1] + 5)) // On compare ici m'angle futur à l'actuel
                    {
